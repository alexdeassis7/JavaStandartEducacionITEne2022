...
public class AppPrincipal {
	...
	public static void main(String[] args) {
		...
		System.out.println("-----------------objeto a3 : estado inicial de sus atributos ---------");
		System.out.println(a3.toString());

		System.out.println("-----------------objeto a3 : estado de sus atributos ---------");
		System.out.println(a3.toString());

		// tarea : modificar el estados de los atributos de a2 y a3 siguiendo el
		// Diagrama de clases ,done
