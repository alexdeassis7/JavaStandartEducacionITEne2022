...
public class Auto {
	...
	// atajo para generar el metodo toString() : alt + shift + 's'
	public String toString() {
		return "Auto [color=" + color + ", cantidadPuertas=" + cantidadPuertas + ", marca=" + marca + ", modelo="
				+ modelo + ", anio=" + anio + ", cilindrada=" + cilindrada + ", precio=" + precio
				+ ", capacidadMaxCombutible=" + capacidadMaxCombutible + ", capacidadActualCombutible="
				+ capacidadActualCombutible + "]";
	}
